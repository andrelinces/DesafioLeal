...
func setupDesign () {
    ...
    cardViewPoster.borderDesigneView(cornerRadius: 38)

}
    func setupView () {
        
        cardViewPoster.changeDesigneView(cornerRadius: 28, shadow: CGSize(width: 0, height: 2), shadowOpacity: 0.3)
...
//    }
    ...
    imageViewExercises.borderDesigneView(cornerRadius: 48)
    imageViewExercises.image = UIImage(named: imageExercisesPoster)
